...
**YOU ARE IN: `mobile_mux/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mobile_mux/` (rig root) or other directories
...
**Your mail address:** `mobile_mux/polecats/furiosa`
**Your rig:** mobile_mux
**Your Witness:** `mobile_mux/witness`
...
| Ask Witness for help | `gt mail send mobile_mux/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mobile_mux/witness`) when:
...
```bash
gt mail send mobile_mux/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
